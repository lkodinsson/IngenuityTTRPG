...
Whether its traps, locks, pockets, or just fancy tricks, all such things are within your grasp. While this skill is generally used for everything a thief would do, it can also be used to conceal objects and perform tricks. This skill is also used to construct disguises for hiding in plain sight.
...
| Name | Primary Stat |
|:-|:-:|
| [Metapowers](#metapowers) | Variable |
...
| Altruism | Impulse | Authority | Community |

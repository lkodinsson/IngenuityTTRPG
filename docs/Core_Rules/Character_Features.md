...
| Intelligence (INT) | Mental ability for discovery and memory |
...
> ***Example***  
> A character who is a bodybuilder could be described as having great strength which would be a d8.
...
| Name | Description |
|:-|:-|
| Health (HP) | Capacity for lasting injuries that are difficult to heal |
| Endurance (ED) | Capacity for superficial injuries that are easy to heal |
| Stamina (ST) | Capacity to use physical special abilities |
| Focus (FC) | Capacity to use mental and social special abilities |
| Fate | Special and limited resource used to influence gameplay |
...
| Deflection (DEF) | Ability to reduce the amount of damage the body takes |
...
| Combat (COM) | Attacking enemies with the body or weaponry |
| Craft (CRA) | Creating or modifying tools, items, gadgets, and mechanisms |
| Handling (HAN) | Using the hands to perform precise, subtle, or gentle activities |
...
Other types of tasks that are beyond the normal space of interaction are handled by the *supernatural* skills. This includes abilities of a magical and nonmagical origin.
...
| Ki | Magic released by manipulating one's own auras |
...
Your *archetype* is built from three parts that work together to provide a summary of who your character is.

##### Table: Archetypal Features
| Name | Description |
|:-|:-|
...
Each part of an archetype also provides other small bonuses that help define your character mechanically, like which skills and proficiencies they start with.
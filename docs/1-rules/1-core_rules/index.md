...
<!--In addition the standard systems there are also some optional rules to further enchance character customization, like *character flaws and biases*, playing without a *character class*, and *randomizing character creation*.-->

...
export default function YAMLTable({tableData=tableDataDefault, headers=headersDefault, values=valuesDefault, align=alignDefault, filters=filtersDefault, sort=sortDefault}) {
    return (
        <table>
            <thead>
